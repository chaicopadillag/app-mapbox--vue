<template>
  <button
    type="button"
    @click="goToLocation"
    class="flex break-inside bg-green-500 text-white border-2 border-black rounded-full px-1.5 py-1.5 fixed top-2 right-4 hover:bg-green-600 z-10"
  >
